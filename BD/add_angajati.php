...
<head>
    ...
    <title>Adăugare Angajat Nou</title>
    <style>
        body {
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // SQL pentru inserarea datelor în tabela angajat
    $sql = "INSERT INTO angajati (nume, prenume,functie, data_angajarii) 
            VALUES ('$nume', '$prenume', '$functie', '$data_angajarii')";

    // Verificare dacă inserarea a fost realizată cu succes
    if (mysqli_query($con, $sql)) {
        echo "Angajat adăugat cu succes!";
    } else {
        echo "Eroare la adăugarea angajatului: " . mysqli_error($con);
    }
...
?>
    ...
    <form action="add_angajati.php" method="post">
